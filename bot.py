...
def verify(code):
    ...
    if user and not user.get("verified"):
        ...
        asyncio.run_coroutine_threadsafe(
            send_verification_success(user['user_id']),
...
async def send_verification_success(user_id):
    try:
        ...
        print(f"Failed to send verification success message: {e}")
...
async def like_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await loading_msg.edit_text(message_text, reply_mup=keyboard, parse_mode='Markdown')
